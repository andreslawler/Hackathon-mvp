...
| Private IMS Core (optional)   | Compact IMS solution including CSCF, MTAS, vSBC, vBGF, IPWorks ENUM and DNS, vMRF and HSS for IMS.                                                                                 | Provides VoLTE and 5G voice services for up to 5 000 active private network voice users in the closed private network. No interconnect, roaming or SRVCC features are in scope.                                                                |
